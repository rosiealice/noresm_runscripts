...
casename="n1850esm.$resolution.fates-nocomp.beta01_alokmods_v9_ic.20250729"
...
cp /cluster/projects/nn9560k/alok/cases_noresm3/test_fco2/SourceMods/src.clm/lnd_import_export.F90 SourceMods/src.clm
	...
	echo "hist_fincl1 = 'FCO2' " >> $scriptsdir$casename/user_nl_clm
        echo "finidat = '/cluster/shared/noresm/inputdata/share_kjetil/i1850.ne30pg3_tn14.fatesnocomp.ctsm5.3.045_noresm_v9.CPLHIST_LUH3_ConstLU_coldstart_v21_wFCO2.20250628.clm2.r.0101-01-01-00000.nc'" >> $scriptsdir$casename/user_nl_clm

        #Add following lines to user_nl_cice
        echo "ice_ic = '/cluster/shared/noresm/inputdata/restart/NOIIAJRAOC20TR_TL319_tn14_ppm_20240816/rest/1775-01-01-00000/NOIIAJRAOC20TR_TL319_tn14_ppm_20240816.cice.r.1775-01-01-00000.nc'" >> $scriptsdir$casename/user_nl_cice   

        #Add following lines to user_nl_blom
        echo 'ICFILE = "/cluster/shared/noresm/inputdata/restart/NOIIAJRAOC20TR_TL319_tn14_ppm_20240816/rest/1775-01-01-00000/NOIIAJRAOC20TR_TL319_tn14_ppm_20240816.blom.r.1775-01-01-00000.nc"' >> $scriptsdir$casename/user_nl_blom
        
        #Add following lines to user_nl_cam
        echo 'use_aerocom = .true.' >> $scriptsdir$casename/user_nl_cam
        echo 'interpolate_nlat = 192' >> $scriptsdir$casename/user_nl_cam
        echo 'interpolate_nlon = 288' >> $scriptsdir$casename/user_nl_cam
        echo 'interpolate_output = .true.' >> $scriptsdir$casename/user_nl_cam
        echo 'history_aerosol = .true.' >> $scriptsdir$casename/user_nl_cam
        echo 'zmconv_c0_lnd = 0.0075D0' >> $scriptsdir$casename/user_nl_cam
        echo 'zmconv_c0_ocn = 0.0300D0' >> $scriptsdir$casename/user_nl_cam
        echo 'zmconv_ke = 5.0E-6' >> $scriptsdir$casename/user_nl_cam
        echo 'zmconv_ke_lnd = 1.0E-5' >> $scriptsdir$casename/user_nl_cam
        echo 'clim_modal_aero_top_press = 1.D-4' >> $scriptsdir$casename/user_nl_cam
        echo 'bndtvg = "/cluster/shared/noresm/inputdata/atm/cam/ggas/noaamisc.r8.nc"' >> $scriptsdir$casename/user_nl_cam
